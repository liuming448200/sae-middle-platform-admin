...
class Ucenter {
  ...
  public static function addUser ($mobile, $username, $password, $usergroups) {
    $query = array(
      'mobile'   => $mobile,
      'username' => $username,
      'password' => $password,
    ...
    $url = APIMap::getAPI(APIConfig::ADD_USER);
  ...
  public static function getUserList ($params) {
    $url = APIMap::getAPI(APIConfig::USER_LIST);
  ...
  public static function setUserStatus ($uid, $status) {
    ...
    $url = APIMap::getAPI(APIConfig::SET_USER_STATUS);
  ...
  public static function setUserInfo ($uid, $usergroups) {
    $query = array(
      'uid'   => $uid,
      'usergroups' => $usergroups
    );

    $url = APIMap::getAPI(APIConfig::SET_USER_INFO);
  ...
  public static function getUserMenu ($usergroups) {
    $query = array(
      'usergroups'     => $usergroups
    );
    $query = http_build_query($query);

    $url = APIMap::getAPI(APIConfig::USER_MEMU);
    $url = $url . '?' . $query;
