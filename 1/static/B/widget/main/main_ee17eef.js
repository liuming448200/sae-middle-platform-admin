define('B:widget/main/main', function(require, exports, module) {
  ...
  require('B:widget/router/router');
  require('B:widget/config/config');
  require('B:widget/webservice/webservice');
