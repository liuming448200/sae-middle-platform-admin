define('B:widget/pages/main/auth/action/list/list.async', function(require, exports, module) {

  return ['$scope', 'webservice', 'menuListService', 'globals', function ($scope, webservice, menuListService, globals) {
